package com.muzafferatmaca.notesapp.util
...
/**
 * Created by Muzaffer Atmaca on 15.06.2022.
 */
class NoteBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun setListener() {
        ...
        fNote1.setOnClickListener {
            ...
            imgNote1.setImageResource(R.drawable.icheck)
        ...
        fNote2.setOnClickListener {
            ...
            imgNote2.setImageResource(R.drawable.icheck)
            imgNote4.setImageResource(0)
            imgNote5.setImageResource(0)
            imgNote6.setImageResource(0)
            imgNote7.setImageResource(0)
        ...
        fNote4.setOnClickListener {
            imgNote1.setImageResource(0)
            imgNote2.setImageResource(0)
            imgNote4.setImageResource(R.drawable.icheck)
            imgNote5.setImageResource(0)
            imgNote6.setImageResource(0)
            imgNote7.setImageResource(0)
        ...
        fNote5.setOnClickListener {
            ...
            imgNote2.setImageResource(0)
            imgNote4.setImageResource(0)
            imgNote5.setImageResource(R.drawable.icheck)
            imgNote6.setImageResource(0)
            imgNote7.setImageResource(0)
        ...
        fNote6.setOnClickListener {
            ...
            imgNote4.setImageResource(0)
            imgNote5.setImageResource(0)
            imgNote6.setImageResource(R.drawable.icheck)
            imgNote7.setImageResource(0)
        ...
        fNote7.setOnClickListener {
            ...
            imgNote5.setImageResource(0)
            imgNote6.setImageResource(0)
            imgNote7.setImageResource(R.drawable.icheck)
